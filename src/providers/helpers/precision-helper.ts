import { AddressData } from 'core/contracts/use-cases/providers/address-provider.interface'
import { GeoPrecision } from 'core/contracts/use-cases/providers/geo-provider.interface'
